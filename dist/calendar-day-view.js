class CalendarDayView extends HTMLElement {
  ...
  async render() {
    ...
    try {
      ...
      const events = this.processEvents(state, today);class CalendarDayView extends HTMLElement {
  constructor() {
    super();
    this.attachShadow({ mode: 'open' });
    this._hass = null;
  ...
  async getCalendarEvents() {
    ...
    if (!this._hass) {
      console.error('Calendar Day View: No hass instance available');
      return [];
    }
...
window.customCards.push({
  ...
  preview: true,
  documentationURL: 'https://github.com/yourusername/ha_calendar',
}); 
      console.log('Calendar Day View: Processed events', events);
